...
🌉 [**lark-coding-agent-bridge**](https://github.com/zarazhangrui/lark-coding-agent-bridge) (<!--stars:lark-coding-agent-bridge-->846+<!--/stars--> stars) - 一个把飞书 / Lark 和本地 Claude Code CLI 打通的机器人：流式卡片、按会话隔离的 session、多 workspace
...
🌉 [**lark-coding-agent-bridge**](https://github.com/zarazhangrui/lark-coding-agent-bridge) (<!--stars:lark-coding-agent-bridge-->846+<!--/stars--> stars) - 把飞书 / Lark 和本地 Claude Code CLI 打通：流式卡片、按会话隔离的 session、多 workspace
