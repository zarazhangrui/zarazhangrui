...
🎞️ [**frontend-slides**](https://github.com/zarazhangrui/frontend-slides) (<!--stars:frontend-slides-->19.9k+<!--/stars--> stars) - 用 coding agent 的前端能力在网页上做出漂亮的幻灯片
...
🎨 [**beautiful-html-templates**](https://github.com/zarazhangrui/beautiful-html-templates) (<!--stars:beautiful-html-templates-->2.3k+<!--/stars--> stars) - 一套 HTML 幻灯片模板库，让任意 coding agent 都能挑出合适的模板，自动生成漂亮的演示文稿
...
🖌️ [**beautiful-feishu-whiteboard**](https://github.com/zarazhangrui/beautiful-feishu-whiteboard) (<!--stars:beautiful-feishu-whiteboard-->10+<!--/stars--> stars) - 24 套精选配色风格，用来制作漂亮、可编辑的飞书 / Lark 画板。一个 agent skill
...
📖 [**youtube-to-ebook**](https://github.com/zarazhangrui/youtube-to-ebook) (<!--stars:youtube-to-ebook-->458+<!--/stars--> stars) - 一个 Claude skill，把你喜欢的频道的 YouTube 字幕转成 EPUB 电子书，定期送到你的邮箱

🎙️ [**personalized-podcast**](https://github.com/zarazhangrui/personalized-podcast) (<!--stars:personalized-podcast-->365+<!--/stars--> stars) - 把任意内容变成一档为你定制的 AI 播客。类似 NotebookLM，但脚本、声音和主持人都由你掌控
